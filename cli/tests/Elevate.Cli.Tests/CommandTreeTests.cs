...
public class CommandTreeTests
{
    ...
    [InlineData("accounts set-client-id alex 11111111-2222-3333-4444-555555555555")]
    [InlineData("accounts set-client-id alex --from-settings")]
    [InlineData("login --method own --client-id 11111111-2222-3333-4444-555555555555")]
